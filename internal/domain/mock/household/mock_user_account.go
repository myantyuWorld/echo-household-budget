...
//
//	mockgen -source=user_account.go -destination=../mock/household/mock_user_account.go -package=mock
//
...
func (m *MockUserAccountRepository) Create(userAccount *household.UserAccount) error {
	m.ctrl.T.Helper()
...
func (m *MockUserAccountRepository) FindByLINEUserID(userID household.LINEUserID) (*household.UserAccount, error) {
	m.ctrl.T.Helper()
