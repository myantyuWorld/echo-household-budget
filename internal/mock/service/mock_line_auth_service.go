...
// Source: internal/service/line_auth_service.go
//
// Generated by this command:
//
//	mockgen -source=internal/service/line_auth_service.go -destination=internal/mock/service/mock_line_auth_service.go -package=mock
//
...
func (m *MockLineAuthService) Callback(c echo.Context, code string) error {
	m.ctrl.T.Helper()
...
func (m *MockLineAuthService) Logout(c echo.Context) error {
	m.ctrl.T.Helper()
